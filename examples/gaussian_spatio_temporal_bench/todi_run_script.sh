...
set -x
#srun -n ${num_ranks} ./bind.sh python run.py >output_gaussian_spatioTemporal_bench_pinned_numaCtl_cpu_omp${OMP_NUM_THREADS}_numRanks${num_ranks}.txt
srun -n ${num_ranks} ./bind.sh ./nsys.sh python run.py >output_gaussian_spatioTemporal_bench_pinned_numaCtl_cpu_numRanks${num_ranks}.txt
