...
set -x
srun -n ${num_ranks} ./bind_todi.sh python sandbox_gaussian_spatioTemporal_medSize.py >output_gaussian_spatioTemporal_medSize_pinned_numaCtl_gpu_numRanks${num_ranks}.txt
