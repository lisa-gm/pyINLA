Datastructure to carry variables, and vectors modified along the way of the execution of the program.
Can store distribututions?
- Check PyMC for storage of distribution and general concept.
